...
| `UPSDK 다운로드 페이지 <https://upsdk-korean.readthedocs.io/ko/master/chapters/chapter09.html#>`_ 에서 사용자 환경에 가장 적합한 버전을 다운로드하세요.
...
| 더 자세한 정보는 유니티 플러그인 다운로드 페이지 `Unity Plugin 다운로드 페이지 <https://upsdk-korean.readthedocs.io/ko/master/Download/Download_Guide.html#unity-sdk>`_ 에서 확인하세요.
