...
[5.0.0 AndroidManifest 다운로드 페이지](http://docs.upltv.com/docs/show/50 "SDKDownLoad")

> 필요한 파일을 찾지 못한 경우 UPLTV의 기술 지원팀 담당자와 상의하세요.

### IV. Unity 프로젝트의 컴파일 에러

Unity 컴파일 에러 해결 방법은 [이곳](http://docs.upltv.com/docs/show/105 "常见问题")에서 Android 결합 문제 솔루션을 참조하시기 바랍니다.
